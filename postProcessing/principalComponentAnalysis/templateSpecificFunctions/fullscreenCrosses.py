...
def main():
    ...
    for templateName in os.listdir(loadPath):
        for distanceScheme in distanceSchemes:
            ...
            data = collectData(loadPath, 'fullscreen', templateName, distanceScheme)
    ...
    print('            Runtime for fullscreen Principal Component Analysis: %.4f seconds'%(time.time() - startTime))
