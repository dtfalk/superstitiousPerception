...
def getPaths():
    ...
    loadAndSavePath = os.path.join(curDir, '..', '..', '..', 'results', 'halfscreenCrosses', 'results')
...
def main():
    ...
    print('            Runtime for halfscreen crosses general statistics: %.4f seconds'%(time.time() - startTime))
