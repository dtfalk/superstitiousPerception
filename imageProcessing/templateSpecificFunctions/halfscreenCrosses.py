...
def getPaths():
    ...
    templatePath = os.path.join(curDir, '..', '..', 'arraysAndImages', 'templates', 'halfscreenCrosses', 'arrays')
    ...
    savePath = os.path.join(curDir, '..', '..', 'results', 'halfscreenCrosses')
...
def main():
    ...
    save(os.path.join(savePath, 'halfscreen.npy'), results)
    ...
    print("        Runtime for halfscreen crosses: %.4f seconds"%(time.time() - startTime))
