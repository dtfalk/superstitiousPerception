...
def getPaths():
    ...
    templatePath = os.path.join(curDir, '..', '..', 'arraysAndImages', 'templates', 'fullscreenCrosses', 'arrays')
    ...
    savePath = os.path.join(curDir, '..', '..', 'results', 'fullscreenCrosses')
...
def main():
    ...
    save(os.path.join(savePath, 'fullscreen.npy'), results)
    ...
    print("        Runtime for fullscreen crosses: %.4f seconds"%(time.time() - startTime))
